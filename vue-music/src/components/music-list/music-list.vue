    ...
    <div class="music-list">
        ...
        <div class="bg-image" :style="bgStyle" ref="bgImage">
            <div class="play-wrapper">
                <div @click="random" class="play" v-show="songs.length" ref="playButton">
                    <i class="icon-play"></i>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            // console.log(`music-list songs:${this.songs}`)
            this.probeType = 3
        ...
        mounted() {
            ...
            this.minTranslateY = -this.imageHight + TITLE_HIGHT
        },
        props: {
            bgImage: {
                type: String,
        ...
        watch: {
            scrollY(newY) {
                ...
                // 滑到顶部时，图片zIndex改变遮住文字，高度缩小
                if (newY < this.minTranslateY) {
                    this.$refs.playButton.style.display = 'none'
                    zIndex = 10
                    this.$refs.bgImage.style.paddingTop = 0
                    this.$refs.bgImage.style.height = `${TITLE_HIGHT}px`
                }
                else {
